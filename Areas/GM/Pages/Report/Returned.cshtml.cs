...
namespace Nkgjjm.Areas.GM.Pages.Report
{
    public class ReturnedModel : PageModel
    {
        ...
        public ReturnedModel(ApplicationDbContext context)
        {
            _context = context;

        }

        public List<SpReturnedFreshStock> SpReturnedFreshStock { get; set; }
        ...
        public async Task<IActionResult> OnGet(DateTime startdate, DateTime enddate, string submit)
        {
            if (string.IsNullOrEmpty(submit))
            {
                ...
                SpReturnedFreshStock = await _context.SpReturnedFreshStock.FromSqlRaw("SpReturnedFreshStock @Startdate,@Enddate,@WareHouse", startdates, enddates, warehouses).ToListAsync();
